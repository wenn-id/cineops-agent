...
const anchors = ['pipeline-stages', 'investigation-form', 'agent-result', 'evidence-list', 'result-status', 'trace-list', 'result-reasoning', 'followup-form', 'followup-thread', 'recovery', 'approve-recovery', 'reject-recovery'];
